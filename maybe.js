...
//      '',
//      'The Maybe type encapsulates the idea of sentinel values returned by functions to',
//      'represent an error or unusual conditions. Authors can return an instance of the',
//      'Just constructor when a function executes successfully, and the Nothing object',
//      'when an error occurs, or the computation is otherwise unsuccessful.',
//      '',
//      'Maybe is the \'base class\' of [[Just]] and [[Nothing]]. It is provided only for',
...
//      'signature: val: any',
//      '',
//      'A Just is a type of [[Maybe]] representing a successful computation. The',
...
//      'signature: val: any',
//      '',
//      'Returns true when the given object is a [[Maybe]] object. Returns false',
//      'otherwise.',
//      '--',
...
//      'signature: val: any',
//      '',
//      'Returns true when the given object is the [[Nothing]] object. Returns false',
//      'otherwise.',
//      '--',
...
//      'values—checked for strict identity—then the new function returns [[Nothing]].',
//      'Otherwise, the result is wrapped in a [[Just]] and returned.',
//      '',
//      'Throws a TypeError if the first argument is not an array or arraylike, or if the',
...
//      'same arity as f. When called, the new function calls the original function and',
//      'calls the given predicate function with the result. If p returns false, then ',
//      '[[Nothing]] is returned, otherwise the result is wrapped in an [[Just]] and',
//      'returned.',
//      '',
...
//      'execution, then [[Nothing]] is returned. Otherwise, the result of the function',
