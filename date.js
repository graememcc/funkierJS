(function() {
  ...
  var makeModule = function(require, exports) {
    ...
    var getDayOfMonth = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getDate. Takes a date object, and returns an',
      'integer representing the day of the month (1-31) of the given date.',
      '--',
    ...
    var getDayOfWeek = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getDay. Takes a date object, and returns an',
      'integer representing the day of the week (0-6) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getDayOfWeek(a); // 2',
      callProp('getDay')
    ...
    var getFullYear = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getFullYear. Takes a date object, and returns a',
      '4 digit number representing the year of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getFullYear(a); // 2000',
    ...
    var getHours = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getHours. Takes a date object, and returns an',
      'integer representing the hour field (0-23) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getHours(a); // 10',
      callProp('getHours')
    ...
    var getMilliseconds = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getMilliseconds. Takes a date object, and returns',
      'an integer representing the milliseconds field (0-999) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var getMinutes = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getMinutes. Takes a date object, and returns an',
      'integer representing the minutes field (0-59) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getMinutes(a); // 11',
      callProp('getMinutes')
    ...
    var getMonth = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getMonth. Takes a date object, and returns an',
      'integer representing the month field (0-11) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getMonth(a); // 1',
      callProp('getMonth')
    ...
    var getSeconds = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getSeconds. Takes a date object, and returns an',
      'integer representing the seconds field (0-59) of the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
      'getSeconds(a); // 12',
      callProp('getSeconds')
    ...
    var toEpochMilliseconds = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getTime. Takes a date object, and returns the',
    ...
    var getTimezoneOffset = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getTimezoneOffset. Takes a date object, and',
    ...
    var getUTCDayOfMonth = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCDate. Takes a date object, and returns an',
      'integer representing representing the day of the month (1-31) of the given date',
      'adjusted for UTC.',
      callProp('getUTCDate')
    );
    ...
    var getUTCDayOfWeek = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCDay. Takes a date object, and returns an',
      'integer representing the day of the week (0-6) of the given date adjusted for',
      'UTC.',
      callProp('getUTCDay')
    );
    ...
    var getUTCFullYear = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCFullYear. Takes a date object, and returns',
      'a 4-digit number representing the year of the given date adjusted for UTC.',
    ...
    var getUTCHours = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCHours. Takes a date object, and returns an',
      'integer representing the hour field of the given date (0-23) adjusted for UTC.',
    ...
    var getUTCMilliseconds = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCMilliseconds. Takes a date object, and',
      'returns an intger representing the milliseconds field (0-999) of the given date',
      'adjusted for UTC.',
    ...
    var getUTCMinutes = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCMinutes. Takes a date object, and returns',
      'an integer representing the minutes field (0-59) of the given date adjusted for',
      'UTC.',
    ...
    var getUTCMonth = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCMonth. Takes a date object, and returns an',
      'integer representing the month field (0-11) of the given date adjusted for UTC.',
    ...
    var getUTCSeconds = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.getUTCSeconds. Takes a date object, and returns',
      'an integer representing the seconds field (0-59) of the given date adjusted for',
      'UTC.',
    ...
    var toLocaleDateString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.toLocaleDateString. Takes a date object, and',
      'returns a string representing the date portion of the object, formatted according',
    ...
    var toDateString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.toDateString. Takes a date object, and returns',
    ...
    var toTimeString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.toTimeString. Takes a date object, and returns a',
      'string representing the time portion of the object.',
    ...
    var toISOString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.toISOString. Takes a date object, and returns a',
      'representation of the date in ISO format.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var toUTCString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.toUTCString. Takes a date object, and returns a',
      'representation of the equivalent date in UTC.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var setDayOfMonth = defineValue(
      ...
      'Date object, and sets the day of the month to the given value. Invalid values',
      'will cause a change in other fields: for example, changing the day to 31 in a',
      'month with 30 days will increment the month, which may in turn increment the',
      'year.',
      '',
    ...
    var setFullYear = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.setFullYear. Takes a year value, and a Date',
      'object, and sets the the year to the given value. This may cause a change in',
      'other fields: for example, setting the year when the month and date are',
      'February 29 may cause those values to change to March 1 if the specified year',
      'was not a leap year.',
      '',
      'Returns the given date.',
      '--',
    ...
    var setHours = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.setHours. Takes a value between 0-23 representing',
      'the hour of the day, and sets the hour to the given value. Invalid values will',
      'cause a change in other fields: if the value > 23, then the day will be',
      'incremented by hours div 24. This may in turn cause a cascade of increments to',
      'other fields.',
      '',
      'Returns the given date.',
      '--',
    ...
    var setMilliseconds = defineValue(
      ...
      'Invalid values will cause a change in other fields: if the value > 999, then the',
      'seconds will be incremented by milliseconds div 1000. This may in turn cause a',
      'cascade of increments to other fields.',
      '',
      'Returns the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var setMinutes = defineValue(
      ...
      'Invalid values will cause a change in other fields: if the given minutes > 59,',
      'then the hours will be incremented by minutes div 60. This in turn may cause a',
      'cascade of increments to other fields.',
      '',
      'Returns the given date.',
      '--',
    ...
    var setMonth = defineValue(
      ...
      'representing the month, and sets the given date\'s month to the that value.',
      'Invalid values will cause a change in other fields: if the given month > 11,',
      'then the year will be incremented by month div 12.',
      '',
      'Returns the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var setSeconds = defineValue(
      ...
      'Invalid values will cause a change in other fields: if the given seconds > 59,',
      'then the minutes will be incremented by seconds div 60. This in turn may cause',
      'a cascade of increments to other fields.',
      '',
      'Returns the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var setTimeSinceEpoch = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.setTime. Takes a value representing the number',
      'of milliseconds since midnight, January 1, 1970, and a date. Simultaneously sets',
      'all the fields of the given date to represent the date and time that is that',
      'many milliseconds since the epoch.',
      '',
      'Returns the given date.',
      '--',
      'var a = new Date(2000, 1, 15, 10, 11, 12, 13);',
    ...
    var setUTCDayOfMonth = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.setUTCDate. Takes a value between 1 and 31,',
      'and a Date object, and sets the day of the month to the local equivalent of',
      'the given value. Invalid values will cause a change in other fields: for',
      'example, changing the day to 31 in a month with 30 days will increment the',
      'month, which may in turn increment the year.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
        d.setUTCDate(val);
    ...
    var setUTCFullYear = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around Date.prototype.setUTCFullYear. Takes a value representing the',
      'year, and a Date object, and sets the year to the local equivalent of the',
      'given value.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
    ...
    var setUTCHours = defineValue(
      ...
      'the given value. Invalid values will cause a change in other fields: if the',
      'value > 23, then the day will be incremented by hours div 24. This may in turn',
      'cause a cascade of increments to other fields.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
        d.setUTCHours(val);
    ...
    var setUTCMilliseconds = defineValue(
      ...
      'of the given value. Invalid values will cause a change in other fields: if the',
      'value > 999, then the seconds will be incremented by milliseconds div 1000. This',
      'may in turn cause a cascade of increments to other fields.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
    ...
    var setUTCMinutes = defineValue(
      ...
      'equivalent of that value. Invalid values will cause a change in other fields: if',
      'the given minutes > 59, then the hours will be incremented by minutes div 60.',
    ...
    var setUTCMonth = defineValue(
      ...
      'of that value. Invalid values will cause a change in other fields if the given',
      'month > 11, then year will be incremented by month div 12.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
        d.setUTCMonth(val);
    ...
    var setUTCSeconds = defineValue(
      ...
      'equivalent of that value. Invalid values will cause a change in other fields: if',
      'the given seconds > 59, then the minutes will be incremented by seconds div 60.',
      'This in turn may cause a cascade of increments to other fields.',
      '',
      'Returns the given date.',
      curry(function(val, d) {
    ...
    var makeDateFromString = defineValue(
      ...
      'classification: date',
      '',
      'A wrapper around calling the Date constructor with a single string argument.',
      '',
      'Throws a TypeError when called with a non-string argument, or a string that',
      'cannot be parsed.',
      '',
    ...
    var makeMonthDate = defineValue(
      ...
      'classification: date',
      '',
      'A curried wrapper around calling the Date constructor with two arguments: the',
      'year and the month. No validation or type checking occurs on the parameters.',
      'Excess arguments are ignored. All other fields in the Date are initialised to',
      'zero, with the exception of the day, which will be 1.',
      '',
      'Returns the new Date.',
      '--',
    ...
    var makeDayDate = defineValue(
      ...
      'classification: date',
      '',
      'makeDayDate: a curried wrapper around calling the Date constructor with three',
      'arguments: the year, the month, and the day. No validation or type checking',
      'occurs on the parameters. Excess arguments are ignored. All other fields in the',
      'Date are initialised to zero.',
      '',
      'Returns the new Date.',
      '--',
    ...
    var makeHourDate = defineValue(
      ...
      'classification: date',
      '',
      'A curried wrapper around calling the Date constructor with four arguments: the',
      'year the month, the day, and the hour. No validation or type checking occurs on',
    ...
    var makeMinuteDate = defineValue(
      ...
      'classification: date',
      '',
      'A curried wrapper around calling the Date constructor with five arguments: the',
      'year the month, the day, the hour and the minute. No validation or type checking',
      'occurs on the parameters. Excess arguments are ignored. All other fields in the',
      'Date are initialised to zero.',
      '',
      'Returns the new Date.',
    ...
    var makeSecondDate = defineValue(
      ...
      'classification: date',
      '',
      'A curried wrapper around calling the Date constructor with six arguments: the',
      'year, the month, the day, the hour, minute, and second. No validation or type',
      'checking occurs on the parameters. Excess arguments are ignored. All other',
      'fields in the Date are initialised to zero.',
      '',
      'Returns the new Date.',
      '--',
    ...
    var makeMillisecondDate = defineValue(
      ...
      'classification: date',
      '',
      'A curried wrapper around calling the Date constructor with seven arguments: the',
      'year, the month the day, the hour, minute, second and millisecond. No validation',
      'or type checking occurs on the parameters. Excess arguments are ignored. All',
      'other fields in the Date are initialised to zero.',
      '',
      'Returns the new Date.',
      '--',
