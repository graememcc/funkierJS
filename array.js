(function() {
  ...
  var makeModule = function(require, exports) {
    ...
    var foldl1 = defineValue(
      ...
      '',
      'Throws a TypeError if the first parameter is not a function of arity 2, if the last parameter',
      'is not an arraylike, or if the arraylike is empty.',
      '--',
    ...
    var insert = defineValue(
      ...
      '0 and the length of the given array/string; a value equal to the length will insert',
      'the new value at the end of the array/string. If passed a string, the value will',
      'be coerced to a string if necessary.',
      '',
    ...
    var removeAll = defineValue(
      ...
      'classification: array',
      '',
      'Takes a value, and an array. Returns a new array with all occurrences of the given value—checked for',
