(function() {
  ...
  var makeModule = function(require, exports) {
    ...
    var callPropWithArity = defineValue(
      ...
      '',
      'Takes a property name, and an arity. Returns a curried function of (arity + 1) arguments.',
      'The new function assumes that the given property is a callable value in the given object',
      'and so takes the (arity) arguments followed by an object to call the property on, returning',
      'the result. The parameters are supplied to the callable property in the order given.',
      '--',
    ...
    var callProp = defineValue(
      ...
      'classification: object',
      '',
      'A shorthand for [[callPropWithArity]](prop, 0). Returns a new function that takes an object',
      'and calls the specified property on the given object.',
      '--',
      'var myConstructor = function() {};',
      'myConstructor.prototype.return42 = function() {return 42;};',
      'var myObj = new myConstructor();',
    ...
    var hasOwnProperty = defineValue(
      ...
      'classification: object',
      '',
      'A curried wrapper around Object.prototype.hasOwnProperty. Takes a string representing a property',
      'name and an object, and returns true if the given object (and not object\'s in the prototype chain)',
    ...
    var hasProperty = defineValue(
      ...
      'name and an object, and returns true if the given object or some property in the object\'s',
      'prototype chain has the specified property.',
      '--',
    ...
    var instanceOf = defineValue(
      ...
      'classification: object',
      '',
      'A curried wrapper around the \'instanceof\' operator. Takes a constructor function and an',
      'object, and returns true if the function\'s prototype property is in the prototype chain',
      'of the given object.',
      '--',
    ...
    var createObject = defineValue(
      ...
      'classification: object',
      '',
      'Returns a new object whose internal prototype property is the given object protoObj.',
      '',
      'Note: this is an unary function that discards excess arguments. If you need to add new',
      'properties at the same time, use [[createObjectWithProps]].',
      '--',
      'var obj = {};',
    ...
    var createObjectWithProps = defineValue(
      ...
      'classification: object',
      '',
      'Creates an object whose internal prototype property is protoObj, and which has the additional properties',
      'described in the given property descriptor object propsObj. The property descriptor object is expected to',
      'be of the form accepted by Object.create, Object.defineProperties etc.',
      '--',
      'var obj = {};',
    ...
    var defineProperty = defineValue(
      ...
      'classification: object',
      '',
      'A curried wrapper around Object.defineProperty. Takes a property name string, a property descriptor',
      'and the object that the object should be defined on. Returns the object o.',
      '',
    ...
    var defineProperties = defineValue(
      ...
      'descriptors and the object that the object should be defined on. Returns the object o.',
      '--',
      'var a = {};',
      'hasOwnProperty(\'foo\', a); // false',
    ...
    var getOwnPropertyDescriptor = defineValue(
      ...
      'classification: object',
      '',
      'A curried wrapper around Object.getOwnPropertyDescriptor. Takes a property name and an object.',
      'If the object itself has the given property, then the object\'s property descriptor for the',
      'given object is returned, otherwise it returns undefined.',
      '--',
      'var a = {foo: 42};',
    ...
    var extractOrDefault = defineValue(
      ...
      'classification: object',
      '',
      'Takes the name of a property, a default value, and an object. Attempts to read the value of',
      'the property from the object, and returns it if present. Returns the given default value if',
      'if the property is not present, or cannot be read.',
      '--',
    ...
    var set = defineValue(
      ...
      'classification: object',
      '',
      'Sets the given property to the given value on the given object, returning the object.',
      'Equivalent to evaluating o[prop] = value. The property will be created if it doesn\'t',
    ...
    var modify = defineValue(
      ...
      '',
      'Sets the given property to the given value on the given object, returning the object.',
      'Equivalent to evaluating o[prop] = value. The property will *not* be created when the object',
    ...
    var modifyOrThrow = defineValue(
      ...
      'Sets the given property to the given value on the given object, returning the object.',
      'Equivalent to evaluating o[prop] = value. The property will *not* be created when the object',
      'does not have the property: instead the function will throw a TypeError. In particular, the',
    ...
    var createProp = defineValue(
      ...
      '',
      '--',
      'Creates the given property with the given value on the given object, returning the object.',
      'Equivalent to evaluating o[prop] = value. The property will *not* be modified when the object',
    ...
    var deleteProp = defineValue(
      ...
      'classification: object',
      '',
      'Deletes the given property from the given object, returning the object. Equivalent to delete o.prop;',
      'The function will silently fail when the property does not exist. It also silently fails when deletion',
      'is disallowed by the \'configurable\' property of the property descriptor, or when the object is sealed',
      'or frozen.',
      '--',
    ...
    var deletePropOrThrow = defineValue(
      ...
      '',
      'Deletes the given property from the given object, returning the object. Equivalent to delete o.prop;',
      'The function will throw when the property does not exist. It also throws when deletion is disallowed',
      'by the \'configurable\' property of the property descriptor, or when the object is sealed or frozen.',
      '--',
    ...
    var keys = defineValue(
      ...
      'classification: object',
      '',
      'A wrapper around Object.keys. Takes an object, and returns an array containing the names',
    ...
    var values = defineValue(
      ...
      'classification: object',
      '',
      'Takes an object, and returns an array containing the values of the object\'s own properties.',
    ...
    var getOwnPropertyNames = defineValue(
      ...
      'classification: object',
      '',
      'A wrapper around Object.getOwnPropertyNames. Takes an object, and returns an array containing the names',
      'of the object\'s own properties, including non-enumerable properties. Returns an empty array for non-objects.',
      'The order of the property names is not defined.',
      '--',
    ...
    var keyValues = defineValue(
      ...
      'classification: object',
      '',
      'Takes an object, and returns an array containing 2-element arrays. The first element of each',
    ...
    var extend = defineValue(
      ...
      'classification: object',
      '',
      'Takes two objects, source and dest, and walks the prototype chain of source, copying',
      'all enumerable properties into dest. Any extant properties with the same name are',
      'overwritten. Returns the modified dest object.',
      '--',
      'var a = {bar: 1};',
    ...
    var extendOwn = defineValue(
      ...
      'classification: object',
      '',
      'Takes two objects, source and dest, and copies all enumerable properties of source',
      'into dest. Properties of the prototype are not copied. Any extant properties with the',
      'same name are overwritten. Returns the modified dest object.',
      '--',
