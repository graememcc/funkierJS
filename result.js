...
//      '',
//      'The Result type encapsulates the idea of functions throwing errors. It can be',
//      'considered equivalent to the Either datatype from Haskell, or the Result type',
//      'from Rust.',
//      '',
//      'Result is the \'base class\' of [[Ok]] and [[Err]]. It is provided only for the',
//      'instanceof operator.',
//      '',
...
//      'signature: val: any',
//      '',
//      'An Ok is a type of [[Result]] representing a successful computation. The',
...
//      'signature: val: any',
//      '',
//      'An Err represents the error from an unsuccessful computation. The constructor is new',
//      'agnostic.',
//      '',
//      'Throws a TypeError when called with no arguments.',
//      '',
...
//      'signature: val: any',
//      '',
//      'Returns true when the given object is a [[Result]] object. Returns false',
//      'otherwise.',
//      '',
//      '--',
...
//      '',
//      'Takes an array of sentinel values, and a function f. Returns a new function with',
//      'the same arity as f. When called, the new function calls the original function',
//      'and examines the result. If the result is contained in the array of sentinel',
//      'values—checked for strict identity—then the result is wrapped in an [[Err]] and',
//      'returned. Otherwise, the result is wrapped in a [[Ok]] and returned.',
//      '',
...
//      '',
//      'Takes a predicate function p, and a function f. Returns a new function with the',
//      'same arity as f. When called, the new function calls the original',
//      'function and the given predicate function is called with the result. If p returns',
//      'false, then the result is wrapped in an [[Err]] and returned, otherwise it is',
//      'wrapped in an [[Ok]] and returned.',
//      '',
...
//      '',
//      'Takes a function f. Returns a new function with the same arity as f. When called,',
//      'the new function calls the original function. If the function f throws during',
//      'execution, then the exception is wrapped in an [[Err]] and returned. Otherwise,',
//      'the result of the function is wrapped in an [[Ok]] and returned.',
//      '',
...
//      '',
//      'Takes two functions of arity 1 or greater, and a [[Result]]. If the [[Result]] is',
//      'an [[Ok]] value, the first function will be called with the unwrapped value.',
//      'Otherwise, if the [[Result]] is an [[Err]] value, the second function is called',
//      'with the unwrapped value. In either case, the result of of the called function is',
//      'returned.',
//      '',
//      'Throws a TypeError if either of the first two arguments is not a function of',
//      'arity 1 or more, or if the given value is not a [[Result]]',
//      '',
//      '--',
