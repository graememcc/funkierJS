(function() {
  ...
  var makeModule = function(require, exports) {
    ...
    var not = defineValue(
      ...
      '',
      'A wrapper around the logical not (!) operator. Returns the logical negation of',
      'the given argument.',
      '--',
      'not(true); // false',
      curry(function(x) {
    ...
    var and = defineValue(
      ...
      'classification: logical',
      '',
      'A wrapper around the logical and (&&) operator. Returns the logical and of the',
      'given arguments.',
      '--',
    ...
    var or = defineValue(
      ...
      'classification: logical',
      '',
      'A wrapper around the logical o& (||) operator. Returns the logical or of the',
      'given arguments.',
      '--',
      'or(false, true); // true',
      curry(function(x, y) {
