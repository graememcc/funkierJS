(function() {
  ...
  var makeModule = function(require, exports) {
    ...
    var Pair = defineValue(
      ...
      '',
      'A Pair represents an immutable tuple. The constructor function takes two elements, first and second.',
      'and returns a new immutable tuple. The contents of the tuple can be accessed with the accessor functions',
      '[[fst]] and [[snd]] respectively. The constructor is new-agnostic.',
      '',
      'The constructor is curried: when called with one argument, a function will be returned that expects a',
      'second argument; supplying this function with a value will yield a Pair.',
      '',
    ...
    var fst = defineValue(
      ...
      'classification: datatypes',
      '',
      'accessor function for pair tuples. Returns the first value that was supplied to the pair constructor.',
      '',
    ...
    var snd = defineValue(
      ...
      'classification: datatypes',
      '',
      'accessor function for pair tuples. Returns the second value that was supplied to the pair constructor.',
      '',
      'Throws a TypeError when called with a non-pair value.',
      '--',
      'var p = new Pair(2, 3);',
    ...
    var asArray = defineValue(
      ...
      'classification: datatypes',
      '',
      'Takes a pair, and returns a 2-element array containing the values contained in the given pair p.',
