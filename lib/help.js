    ...
    var helpFn = function(value) {
      switch (value) {
        ...
        case funkier.bindWithContextAndArity:
          ...
          console.log('the supplied execution context, and whose arity equals the arity given. The supplied arity need not equal the');
          console.log('function\'s length. The function will be only called when the specified number of arguments have been supplied.');
          console.log('Superfluous arguments are discarded. It is possible to partially apply the resulting function, and indeed the');
          console.log('further resulting function(s). The resulting function and its partial applications will throw if they require at');
          console.log('least one argument, but are invoked without any. `bindWithContextAndArity` throws if the arity is not a natural');
        ...
        case funkier.objectCurryWithArity:
          ...
          console.log('context active when the first arguments are supplied. This means that if partially applying the function, the');
          ...
          console.log('applications will throw if they require at least one argument, but are invoked without any. `objectCurryWithArity`');
