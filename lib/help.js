    ...
    var helpFn = function(value) {
      switch (value) {
        ...
        case funkier.bindWithContextAndArity:
          ...
          console.log('least one argument, but are invoked without any. `bind` throws if the arity is not a natural number, if the second');
          console.log('parameter is not an acceptable type for an execution context, or if the last parameter is not a function.');
          console.log('');
